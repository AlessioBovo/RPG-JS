...
function changeHTML(){
    ...
    a.innerHTML="<div class='bedroom' id='bedroom'> <div class='row'> <div class='col-12'> <p class='text-center text-bedroom box'></p></div></div><div class='row'> <div class='col-12'>. <p class='text-center text-bedroom box'>Tu te réveilles, il fait sombre et humide....</p></div></div><div class='row'> <div class='col-12'>. <p class='text-center text-bedroom box'>Tu es seul(e). Tu te demandes bien ce que tu fais là hein ? </p></div></div><div class='row'> <div class='col-6 mx-auto d-block'> <div class='container text-center'> <button id='singlebutton' name='singlebutton' class='btn btn-light button-start' onclick='changeHTML2();'>Continuer</button> </div></div></div></div>";
}
...
function changeHTML2(){
    ...
    a.innerHTML="<div class='bedroom' id='bedroom1'> <div class='row'> <div class='col-12'> <p class='text-center text-bedroom box'>Bonjour Patient n°5, j'espère que la salle vous plait...</p></div></div><div class='row'> <div class='col-12'> <p class='text-center text-bedroom'>Je vous ai préparé quelques petites épreuves, faites attention aux choix que vous faites.</p></div></div><div class='row'> <div class='col-12'> <p class='text-center text-bedroom'>Si vous tenez à la vie, faites les bons choix.</p></div></div><div class='row'> <div class='col-12'> <p class='text-center text-bedroom'></p></div></div><div class='row'> <div class='col-12 mx-auto'> <p class='text-center text-bedroom' id='sayname'>Les 4 patients avant vous sont.... Comment dire.. Huuuum MORTES <br> Bonne Chance.</p></div><div class='container text-center'><button id='singlebutton' name='singlebutton' class='btn btn-light button-start' onclick='changeHTML3();'>Continuer</button></div></div></div>";
}
